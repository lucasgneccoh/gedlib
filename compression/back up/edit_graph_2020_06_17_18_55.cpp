...
void get_graphs_structure(ged::GEDEnv<UserNodeID, UserNodeLabel, UserEdgeLabel> &env,
	...
	std::size_t max_nodes_attr = 0;
	std::size_t max_edges = 0;
	std::size_t max_edges_attr = 0;
...
int main(int argc, char* argv[]){
	...
	*/
	...
	std::string dataset{"Mutagenicity"};
	std::string class_test{"_fake"};
	std::string extra_dir{"/data"};
