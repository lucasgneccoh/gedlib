...
int main(int argc, char* argv[]){
	...
	*/
	...
	blobs.init(ged::Options::InitType::LAZY_WITH_SHUFFLED_COPIES);
	...
	ged::NodeMap node_map_itself = blobs.get_node_map(g2_id, g2_id);
	std::cout<<"G_1 to G_2: "<<node_map<<std::endl<<std::endl;
	std::cout<<"EMPTY to G_2: "<<node_map_empty<<std::endl<<std::endl;
	std::cout<<"G_2 to G_2: "<<node_map_itself<<std::endl<<std::endl;
	...
	if(print_itself){
		std::cout<<"--------------COMPRESSION ON SHUFFLED COPY to G_2-----------------"<<std::endl;
		get_all_compression_sets<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel>(node_map_itself, v_d, v_i, varphi_i, 
			v_s, v_is, varphi_s, e_nd,e_ed, e_ni,e_ei, phi_ni, phi_ei, e_s,e_is, phi_s, g_ex_2, g_ex_2);
	...
	std::cout<<"--------------FROM G_2 to itself-----------------"<<std::endl;
	
	comp_sizes = compression_size<ged::GXLNodeID, ged::GXLLabel, ged::GXLLabel>(node_map_itself, g_ex_2, g_ex_2, b_ni,b_na, b_ei, b_ea);
 	std::cout<<"Vertex compression: "<<comp_sizes.first<<std::endl;
 	std::cout<<"Edge compression: "<<comp_sizes.second<<std::endl;
	std::cout<<"Total compression: "<<comp_sizes.first + comp_sizes.second<<std::endl;

	std::cout<<"GED G_2 to itself: "<<blobs.get_upper_bound(g2_id, g2_id)<<std::endl;
