...
std::size_t compute_cost_edge_pairs(std::size_t & V, std::size_t & E, std::size_t &b_ni, std::size_t &b_na, std::size_t &b_ei, std::size_t &b_ea){return b_ni + V*(V-1)/2 + V*b_na + E*b_ea;}

std::size_t compute_cost_triangular_matrix(std::size_t & V, std::size_t & E, std::size_t &b_ni, std::size_t &b_na, std::size_t &b_ei, std::size_t &b_ea){return b_ni + V*b_na + E*(2*b_ni + b_ea);}
...
void compress_collection(ged::GEDEnv<UserNodeID, UserNodeLabel, UserEdgeLabel> &env, 
	...
	std::size_t omega = std::numeric_limits<std::size_t>::max()*0.1;
