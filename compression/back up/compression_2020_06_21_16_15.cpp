...
int main(int argc, char* argv[]){
	...
	*/
	...
	if(cost_version==0){
		...
		comp_costs.emplace.back(b_na);
		comp_costs.emplace.back(b_ni);
		comp_costs.emplace.back(b_ni + b_na);
		comp_costs.emplace.back(2*b_ni+b_ea);
		comp_costs.emplace.back(b_ei);
		comp_costs.emplace.back(b_ei + b_ea);
