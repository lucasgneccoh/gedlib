...
if __name__ == "__main__":
	...
	# Original
	filename = "/home/lucas/Documents/stage/gedlib/compression/data/collections/Lucas_test.xml"
	
	dataset_path = "/home/lucas/Documents/stage/gedlib/compression/data/datasets/Lucas_test"
	...
	for i, g in enumerate(data):
		draw_lucas(g, ax[int(i/cols), i%cols])
		ax[int(i/cols), i%cols].set_title(g.name)
	
	plt.show()
	
	# Decompressed
	filename = "/home/lucas/Documents/stage/gedlib/compression/data/output/compressed/Lucas/decoded/Lucas.xml"
